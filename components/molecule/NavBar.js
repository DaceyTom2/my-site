...
export default function NavBar(props) {
  ...
  return (
    <>
      ...
      <div
        className={[
          "sm:h-12 w-full sm:w-auto absolute top-0 right-0 sm:top-auto sm:left-auto flex sm:flex bg-white border-x-2 border-b-2 border-gray-300 sm:border-0 sm:bg-transparent ",
          OpenNav ? "" : " hidden",
        ]}
      >
